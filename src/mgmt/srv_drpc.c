...
static int pool_create_fill_resp(Mgmt__PoolCreateResp *resp, uuid_t uuid, d_rank_list_t *svc_ranks)
{
	...
	resp->tier_bytes[DAOS_MEDIA_SCM] = pool_info.pi_space.ps_space.s_total[DAOS_MEDIA_SCM];
	resp->tier_bytes[DAOS_MEDIA_NVME] = pool_info.pi_space.ps_space.s_total[DAOS_MEDIA_NVME];
