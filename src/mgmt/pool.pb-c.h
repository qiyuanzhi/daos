...
typedef struct Mgmt__PoolProperty Mgmt__PoolProperty;
typedef struct Mgmt__PoolSetPropReq Mgmt__PoolSetPropReq;
typedef struct Mgmt__PoolSetPropResp Mgmt__PoolSetPropResp;
typedef struct Mgmt__PoolGetPropReq Mgmt__PoolGetPropReq;
typedef struct Mgmt__PoolGetPropResp Mgmt__PoolGetPropResp;
typedef struct Mgmt__PoolUpgradeReq Mgmt__PoolUpgradeReq;
typedef struct Mgmt__PoolUpgradeResp Mgmt__PoolUpgradeResp;
...
#define MGMT__POOL_QUERY_RESP__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&mgmt__pool_query_resp__descriptor) \
    , 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, 0, 0, NULL, 0,NULL, 0, 0, 0, (char *)protobuf_c_empty_string, (char *)protobuf_c_empty_string, 0, 0 }
...
typedef enum {
  ...
  MGMT__POOL_PROPERTY__VALUE_NUMVAL = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(MGMT__POOL_PROPERTY__VALUE__CASE)
} Mgmt__PoolProperty__ValueCase;

struct  Mgmt__PoolProperty
{
  ProtobufCMessage base;
  /*
