		...
		"null rankset": {
			pqr: &PoolQueryResp{
				...
				PoolInfo: PoolInfo{
					...
					Version:              5,
					Leader:               6,
					CurrentGlobalVersion: 7,
					LatestGlobalVersion:  8,
				},
			},
			exp: `{"enabled_ranks":null,"disabled_ranks":null,"status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_nodes":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
		},
		"valid rankset": {
			pqr: &PoolQueryResp{
				Status: 0,
			...
			exp: `{"enabled_ranks":[0,1,2,3,5],"disabled_ranks":[],"status":0,"uuid":"foo","total_targets":1,"active_targets":2,"total_nodes":3,"disabled_targets":4,"version":5,"leader":6,"rebuild":null,"tier_stats":null,"current_global_version":7,"latest_global_version":8}`,
		},
	} {
		t.Run(name, func(t *testing.T) {
